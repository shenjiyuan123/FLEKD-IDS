...
def main(proxy_num=420, client_num=6, label_num = 7):
    # random.seed(42)
    each_client_proxy_num = proxy_num // client_num
    each_class_proxy_num = each_client_proxy_num // label_num
    print(each_class_proxy_num)
    csv_file_folder = '/export/home2/jiyuan/CIC2019/CSV-03-11/03-11/fl_split_by_label/X_train_Y_train'
    client_files = [os.path.join(csv_file_folder, "client_" + str(i) + ".csv") for i in range(client_num)]
    out_base_folder = '/export/home2/jiyuan/CIC2019/CSV-03-11/03-11/kd_fl_split_by_label'
